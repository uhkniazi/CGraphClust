# File: cluster_test_data_3.R
# Auth: Umar Niazi u.niazi@imperial.ac.uk
# Date: 17/03/2016
# Desc: generate clusters for data from hc, ltb and atb dataset
...
dir.create('Results', showWarnings = F)
write.csv(dfTopGenes.cent, file='Results/Top_Centrality_Genes_ltb_atb.csv')
...
pdf('Results/cluster_variance_ltb_atb.pdf')
par(mfrow=c(1,2))
