# File: cluster_merged_data.R
# Auth: Umar Niazi u.niazi@imperial.ac.uk
# Date: 21/03/2016
# Desc: generate clusters for after choosing unique graph from ltbi dataset
...
dir.create('Results', showWarnings = F)
write.csv(dfTopGenes.cent, file='Results/Top_Centrality_Genes_ltb_unique.csv')
...
csClust = rownames(m)
length(csClust)
pdf('Results/cluster_variance_ltb_unique.pdf')
par(mfrow=c(1,2))
