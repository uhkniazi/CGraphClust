# File: cluster_test_data_4.R
# Auth: Umar Niazi u.niazi@imperial.ac.uk
# Date: 24/06/2015
# Desc: generate non survivors clusters for data from sepsis dataset
...
dir.create('Results', showWarnings = F)
write.csv(dfTopGenes.cent, file='Results/Top_Centrality_Genes_sepsis_nonsurvivors.csv')
...
write.csv(dfCluster, file='Results/Clusters_sepsis_nonsurvivors.csv')
